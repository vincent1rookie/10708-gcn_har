...
data = dict(
    ...
    train=dict(
        type='PoseDataset',
        ann_file='/home/tong/10708/skeleton_train/',
        data_prefix='',
        pipeline=[
            dict(type='PaddingWithLoop', clip_len=30),
            dict(type='PoseDecode'),
    ...
    val=dict(
        type='PoseDataset',
        ann_file='/home/tong/10708/skeleton_new/',
        data_prefix='',
        pipeline=[
            dict(type='PaddingWithLoop', clip_len=30),
            dict(type='PoseDecode'),
...
load_from = None
resume_from = '/home/tong/10708/gcn/10708-gcn_har/mmaction2/stgcn_loc_5_modify_dataset/'
workflow = [('train', 1)]
gpu_ids = [0]
omnisource = False
module_hooks = []
