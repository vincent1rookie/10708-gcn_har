...
# learning policy
lr_config = dict(policy='step', step=[16, 21])
total_epochs = 24
checkpoint_config = dict(interval=3, create_symlink=False)
workflow = [('train', 1)]
evaluation = dict(
    interval=3, metrics=['top_k_accuracy', 'mean_class_accuracy'], topk=(1, 5))
log_config = dict(
    interval=20, hooks=[
...
load_from = 'https://download.openmmlab.com/mmaction/skeleton/posec3d/slowonly_r50_u48_240e_gym_keypoint/slowonly_r50_u48_240e_gym_keypoint-b07a98a0.pth'  # noqa: E501
resume_from = None
